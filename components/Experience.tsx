...
const ExperienceCard = ({
	...
	return (
		...
		>
			...
			<div
				className={`bg-white border border-slate-200 p-8 md:p-10 rounded-2xl transition-all duration-300 shadow-sm hover:shadow-xl hover:border-blue-300 ml-8 md:ml-0 ${
					index % 2 === 0
			...
			>
				<div className='flex flex-wrap items-center gap-3 mb-6'>
					...
					<div className='inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-slate-50 text-[10px] font-bold tracking-widest uppercase text-slate-500'>
				...
				<h3 className='text-3xl font-black text-slate-900 mb-2 tracking-tight group-hover:text-blue-600 transition-colors font-manrope'>
					{position}
				</h3>

				<h4 className='text-xl font-bold text-slate-500 mb-6 flex items-center gap-2 font-manrope'>
...
const Experience = () => {
	return (
		...
		>
			<div className='absolute right-0 top-0 w-1/3 h-full bg-blue-50/50 rounded-l-full -z-0 hidden lg:block opacity-50'></div>
			...
			<div className='max-w-7xl w-full px-4 sm:px-6 lg:px-8 relative z-10'>
				...
				>
					<div className='inline-flex items-center gap-2 px-4 py-2 bg-white rounded-lg shadow-sm text-blue-600 font-bold text-sm tracking-widest uppercase mb-6 border border-slate-200 font-manrope'>
						<Icon icon='mdi:briefcase-outline' className='text-xl' />
						Experience
					</div>
					<h2 className='text-5xl md:text-7xl font-black tracking-tight mb-8 text-slate-900 leading-none font-manrope'>
				...
				<div className='relative'>
					<motion.div
						...
						className='absolute left-2 md:left-1/2 top-4 w-1 bg-blue-200 md:-translate-x-1/2 rounded-full'
					/>
